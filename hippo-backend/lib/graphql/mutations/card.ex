defmodule Hippo.GraphQL.Mutations.Card do
  ...
  object :card_mutations do
    ...
    field :create_card, :card do
      arg(:lane_id, non_null(:UUID), description: "the parent lane ID to create the card into")
    ...
    field :update_card, :card do
      arg(:card_id, non_null(:UUID), description: "which card do we want to update")
    ...
    field :delete_card, :delete_card_result do
      arg(:card_id, non_null(:UUID), description: "the id of the card to delete")
